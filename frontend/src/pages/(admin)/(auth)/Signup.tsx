    ...
    return (
        <div className="container mx-auto relative min-h-screen flex items-center justify-center">
            <div className="w-full p-4 lg:p-8 h-full flex items-center justify-center">
                <div className="flex w-full flex-col justify-center sm:w-100">
                    <Card className="border-none shadow-none lg:shadow-sm lg:border">
                        <CardHeader className="space-y-1">
                            <CardTitle className="text-2xl font-semibold tracking-tight">New Admin</CardTitle>
                        ...
                        <CardContent>
                            ...
                            <div>
                                <p className='text-center text-sm mt-3'>Already have an account? <Link to="/admin/login" className='text-indigo-600 font-semibold'>Login</Link></p>
                            </div>
                        </CardContent>
                    </Card>
                </div>
